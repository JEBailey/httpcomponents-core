...
import io.github.http.MessageConstraintException;
import io.github.http.config.MessageConstraints;
import io.github.http.impl.SessionInputBufferMock;
import io.github.http.impl.SessionOutputBufferMock;
...
public class TestSessionInOutBuffers {
    ...
    public void testBasicReadWriteLine() throws Exception {
        ...
        buffer.append("123456789 ".repeat(15));
    ...
    public void testWriteSmallFragmentBuffering() throws Exception {
        ...
        Mockito.verify(outStream, Mockito.times(1)).write(
                any(), anyInt(), anyInt());
        Mockito.verify(outStream, Mockito.never()).write(anyInt());
    }
    ...
    public void testWriteSmallFragmentNoBuffering() throws Exception {
        ...
        Mockito.verify(outStream, Mockito.times(2)).write(
                any(), anyInt(), anyInt());
        Mockito.verify(outStream, Mockito.times(2)).write(anyInt());
    }
