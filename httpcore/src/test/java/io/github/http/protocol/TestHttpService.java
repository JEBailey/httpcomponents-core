...
public class TestHttpService {
    ...
    public void testExecutionEntityEnclosingRequestCustomExpectationVerifier() throws Exception {
        ...
        final HttpExpectationVerifier expectationVerifier = (request, response, context) -> response.setStatusCode(HttpStatus.SC_UNAUTHORIZED);
    ...
    public void testNoContentResponse() throws Exception {
        ...
        Mockito.verify(conn).sendResponseHeader(response);
        Mockito.verify(conn, Mockito.never()).sendResponseEntity(any());
        Mockito.verify(conn).flush();
        Mockito.verify(conn, Mockito.never()).close();
    }
