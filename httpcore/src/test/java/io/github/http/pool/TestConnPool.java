...
public class TestConnPool {
    ...
    public void testLeaseRelease() throws Exception {
        ...
        final LocalConnFactory connFactory = Mockito.mock(LocalConnFactory.class);
        Mockito.when(connFactory.create(eq("somehost"))).thenReturn(conn1);
        Mockito.when(connFactory.create(eq("otherhost"))).thenReturn(conn2);
    ...
    public void testMaxLimits() throws Exception {
        ...
        Mockito.verify(connFactory, Mockito.times(3)).create(any(String.class));
        ...
        Mockito.verify(connFactory, Mockito.times(4)).create(any(String.class));
    }
    ...
    public void testConnectionRedistributionOnTotalMaxLimit() throws Exception {
        ...
        Mockito.when(connFactory.create(eq("somehost"))).thenReturn(conn1, conn2, conn3);
        ...
        Mockito.when(connFactory.create(eq("otherhost"))).thenReturn(conn4, conn5);
        ...
        Mockito.verify(connFactory, Mockito.times(2)).create(eq("somehost"));
        Mockito.verify(connFactory, Mockito.never()).create(eq("otherhost"));
        ...
        Mockito.verify(connFactory, Mockito.times(2)).create(eq("somehost"));
        Mockito.verify(connFactory, Mockito.times(2)).create(eq("otherhost"));
        ...
        Mockito.verify(connFactory, Mockito.times(3)).create(eq("somehost"));
        Mockito.verify(connFactory, Mockito.times(2)).create(eq("otherhost"));
    ...
    public void testCreateNewIfExpired() throws Exception {
        ...
        Mockito.verify(connFactory, Mockito.times(1)).create(eq("somehost"));
    ...
    public void testCloseExpired() throws Exception {
        ...
        Mockito.when(connFactory.create(eq("somehost"))).thenReturn(conn1, conn2);
    ...
    public void testValidateConnectionNotStale() throws Exception {
        ...
        final LocalConnFactory connFactory = Mockito.mock(LocalConnFactory.class);
        Mockito.when(connFactory.create(eq("somehost"))).thenReturn(conn);
